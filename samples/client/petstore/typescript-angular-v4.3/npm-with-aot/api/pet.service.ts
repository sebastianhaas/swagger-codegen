...
export class PetService {
    ...
    public updatePetWithForm(petId: number, name?: string, status?: string): Observable<{}> {
        ...
        return this.httpClient.post<any>(`${this.basePath}/pet/${encodeURIComponent(String(petId))}`, formParams, {
            headers: headers,
            withCredentials: this.configuration.withCredentials,
        });
    }
    ...
    public uploadFile(petId: number, additionalMetadata?: string, file?: Blob): Observable<ApiResponse> {
        ...
        return this.httpClient.post<any>(`${this.basePath}/pet/${encodeURIComponent(String(petId))}/uploadImage`, formParams, {
            headers: headers,
            withCredentials: this.configuration.withCredentials,
        });
    }
