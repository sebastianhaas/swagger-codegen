...
public class TypeScriptAngular2ClientCodegen extends AbstractTypeScriptClientCodegen {
    ...
    public Map<String, Object> postProcessOperations(Map<String, Object> operations) {
        ...
        for(Map<String, Object> im : imports) {
            ...
            im.put("whitespaces", getWhitespacesForImportIndentation(im.get("classname").toString(), 62));
        }
    ...
    public Map<String, Object> postProcessModels(Map<String, Object> objs) {
        ...
        for (Object _mo : models) {
            ...
            for(String im : cm.imports) {
                ...
                tsImports.put("whitespaces", getWhitespacesForImportIndentation(im, 40));
    ...
    private String getWhitespacesForImportIndentation(String classname, int column) {
        int required = column - 1 - classname.length() - "import {  }".length();
        String whitespaces = "";
